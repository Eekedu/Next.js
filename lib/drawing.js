Image.prototype.show = function(x, y, w, h, frame, dW, dH){
  ...
  function arc(x, y, radius, startA, endA, filled){
    cx.beginPath();
    cx.arc(x, y, radius, startA, endA);
    if (filled) { cx.fill(); }
    cx.stroke();
  }

  function circle(x, y, radius, filled){
    arc(x, y, radius, 0, TWO_PI, filled);
  }
  ...
  function fill(r, g, b, a){
    if (r instanceof Color){
      cx.fillStyle = checkColor(r.r, r.g, r.b, r.a);
    } else {
  ...
  function stroke(r, g, b, a){
    if (r instanceof Color){
      cx.strokeStyle = checkColor(r.r, r.g, r.b, r.a);
    } else {
